...
//                break;
            ...
            case 'instagram':
                ...
                if (!empty($matches[1])) {
                    ...
                    if (!empty($instagram_get_user_data)) {
                        $instagram_json = json_decode( $instagram_get_user_data, true );
                        if (!empty($instagram_json['data']['counts']['followed_by'])) {
                            $buffy_array = (int) $instagram_json['data']['counts']['followed_by'];
                        }
                    }
                }
                break;
            ...
            case 'tiktok':
                $td_data = @$this->get_json("https://www.tiktok.com/node/share/user/$user_id");

                if ( is_array($td_data) && !empty($td_data['body']['userData']['fans']) ) {
                    $buffy_array = $td_data['body']['userData']['fans'];
                }
                break;
