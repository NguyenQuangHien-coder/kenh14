            ...
            $buffy .= '<div class="tdb-block-inner td-fix-index">';
                ...
                $buffy .= '<form method="get" class="tdb-search-form" action="' . esc_url(home_url( '/' )) . '">';
                    $buffy .= '<div role="search" class="tdb-search-form-inner">';
                        $buffy .= '<input class="tdb-search-form-input" type="text" value="' . $search_form_data['search_query'] . '" name="s" />';
                        $buffy .= '<div class="tdb-search-form-border"></div>';
                        $buffy .= $input_placeholder;
                        $buffy .= '<button class="wpb_button wpb_btn-inverse tdb-search-form-btn" type="submit">';
                            if( $btn_icon_pos == '' ) {
                                $buffy .= $btn_icon;
                            }
                            $buffy .= $btn_text;
