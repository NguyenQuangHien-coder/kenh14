...
class tdb_category_grid_10 extends td_block {
    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
                ...
                .$unique_block_class .tdb-cat-grid-post-2 {
				...
				/* @image_height3 */
                @media (max-width: 767px) {
                    .$unique_block_class .tdb-cat-grid-post-1 .td-image-wrap,
                    .$unique_block_class .tdb-cat-grid-post-2 .td-image-wrap {
				...
				/* @video_icon3 */
                @media (max-width: 767px) {
                    .$unique_block_class .tdb-cat-grid-post-1 .td-video-play-ico,
                    .$unique_block_class .tdb-cat-grid-post-2 .td-video-play-ico {
                        width: @video_icon3;
                        height: @video_icon3;
				...
				/* @meta_width3 */
                @media (max-width: 767px) {
                    .$unique_block_class .tdb-cat-grid-post-1 .td-module-meta-info,
                    .$unique_block_class .tdb-cat-grid-post-2 .td-module-meta-info {
					    width: @meta_width3;
                    }
				}
				...
				/* @meta_padding3 */
                @media (max-width: 767px) {
                    .$unique_block_class div.tdb-cat-grid-post-1 .td-module-meta-info,
                    .$unique_block_class div.tdb-cat-grid-post-2 .td-module-meta-info {
				...
				/* @art_title3 */
                @media (max-width: 767px) {
                    .$unique_block_class .tdb-cat-grid-post-1 .tdb-module-title-wrap,
                    .$unique_block_class .tdb-cat-grid-post-2 .tdb-module-title-wrap {
					    margin: @art_title3;
                    }
				}
				...
				/* @art_title_padd3 */
                @media (max-width: 767px) {
                    .$unique_block_class .tdb-cat-grid-post-1 .entry-title,
                    .$unique_block_class .tdb-cat-grid-post-2 .entry-title {
                ...
                @media (max-width: 767px) {
                    ...
                    .$unique_block_class .tdb-cat-grid-post-2 .td-editor-date {
                ...
                @media (max-width: 767px) {
                    .$unique_block_class .tdb-cat-grid-post-1 .td-post-category,
                    .$unique_block_class .tdb-cat-grid-post-2 .td-post-category {
                ...
                @media (max-width: 767px) {
                    ...
                    .$unique_block_class .tdb-cat-grid-post-2 .td-post-author-name {
                ...
                @media (max-width: 767px) {
                    ...
                    .$unique_block_class .tdb-cat-grid-post-2 .td-post-date,
                    .$unique_block_class .tdb-cat-grid-post-2 .td-post-author-name span {
					    display: @show_date3;
                    }
				}
				...
				/* @review_size1 */
				@media (min-width: 767px) {
                    .$unique_block_class .tdb_module_cat_grid_1 .td-icon-star,
                    .$unique_block_class .tdb_module_cat_grid_1 .td-icon-star-empty,
                    .$unique_block_class .tdb_module_cat_grid_1 .td-icon-star-half {
                ...
                @media (max-width: 767px) {
                    ...
                    .$unique_block_class .tdb-cat-grid-post-2 .entry-review-stars {
                ...
                @media (max-width: 767px) {
                    ...
                    .$unique_block_class .tdb-cat-grid-post-2 .td-icon-star,
                    .$unique_block_class .tdb-cat-grid-post-2 .td-icon-star-empty,
                    .$unique_block_class .tdb-cat-grid-post-2 .td-icon-star-half  {
				...
				.$unique_block_class .tdb-cat-grid-post-5 .td-image-wrap:before {
				    content: '';
				...
				.$unique_block_class .tdb-cat-grid-post-6 .td-image-wrap:before {
				    content: '';
                ...
                @media (max-width: 767px) {
                    .$unique_block_class .tdb-cat-grid-post-1 .td-editor-date,
                    .$unique_block_class .tdb-cat-grid-post-1 .td-module-comments a,
                    .$unique_block_class .tdb-cat-grid-post-2 .td-editor-date,
                    .$unique_block_class .tdb-cat-grid-post-2 .td-module-comments a {
					    @f_meta3
                    }
				}
    ...
    function inner( $posts, $td_column_number ) {
        ...
        if ( !empty( $posts )) {
            ...
            foreach ( $posts as $post ) {
                ...
                $tdb_module_cat_2 = new tdb_module_cat_grid_2($post, $this->get_all_atts());
            ...
            if ($post_count < self::POST_LIMIT) {
                for ($i = $post_count; $i < self::POST_LIMIT; $i++) {
                    ...
                    $tdb_module_cat_2 = new tdb_module_cat_grid_2_empty($post, $this->get_all_atts());
                    $buffy .= $tdb_module_cat_2->render($i, 'tdb_module_cat_grid_2');
