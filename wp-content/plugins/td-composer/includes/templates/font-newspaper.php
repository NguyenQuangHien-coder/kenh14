...
<span data-font_class="td-icon-cart-empty"><i class="td-icon-cart-empty td-size-big"></i></span>
<span data-font_class="td-icon-profile"><i class="td-icon-profile td-size-big"></i></span>
<span data-font_class="td-icon-log-out"><i class="td-icon-log-out td-size-big"></i></span>