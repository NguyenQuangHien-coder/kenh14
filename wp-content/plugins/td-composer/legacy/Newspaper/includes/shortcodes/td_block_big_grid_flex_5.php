 ...
 */
class td_block_big_grid_flex_5 extends td_block {
    ...
    static function cssMedia( $res_ctx ) {
        ...
        if( $video_icon3 == '' ) {
            $res_ctx->load_settings_raw( 'video_icon3', '30px' );
        } else {
        ...
        if( $show_author3 == 'none' && $show_date3 == 'none'  && $show_review3 == 'none' ) {
            ...
            $res_ctx->load_settings_raw( 'hide_author_date3', 'inline-block' );
        }
    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
				...
				/* @image_alignment3 */
				div.$unique_block_class .td_module_flex_8 .entry-thumb {
				...
				/* @image_height3 */
				div.$unique_block_class .td_module_flex_8 .td-image-wrap {
				...
				/* @video_icon3 */
				div.$unique_block_class .td_module_flex_8 .td-video-play-ico {
					width: @video_icon3;
					height: @video_icon3;
				...
				/* @image_width3 */
				div.$unique_block_class .td_module_flex_8 {
					width: @image_width3;
				}
				...
				/* @meta_width3 */
				div.$unique_block_class .td_module_flex_8 .td-module-meta-info {
					width: @meta_width3;
				}
				...
				/* @art_title3 */
				div.$unique_block_class .td_module_flex_8 .tdb-module-title-wrap {
					margin: @art_title3;
				}
				...
				/* @art_title_padd3 */
				div.$unique_block_class .td_module_flex_8 .entry-title {
				...
				/* @auth_date_padding3 */
				div.$unique_block_class .td_module_flex_8 .td-editor-date {
				...
				div.$unique_block_class .td_module_flex_8 .td-post-category {
				...
				/* @show_author3 */
				div.$unique_block_class .td_module_flex_8 .td-post-author-name {
				...
				/* @show_date3 */
				div.$unique_block_class .td_module_flex_8 .td-post-date,
				div.$unique_block_class .td_module_flex_8 .td-post-author-name span {
					display: @show_date3;
				}
				...
				/* @show_review3 */
				div.$unique_block_class .td_module_flex_8 .entry-review-stars {
					display: @show_review3;
				}
				/* @review_size3 */
				div.$unique_block_class .td_module_flex_8 .td-icon-star,
                div.$unique_block_class .td_module_flex_8 .td-icon-star-empty,
                div.$unique_block_class .td_module_flex_8 .td-icon-star-half {
				...
				/* @f_meta3 */
				div.$unique_block_class .td_module_flex_8 .td-editor-date,
				div.$unique_block_class .td_module_flex_8 .td-module-comments a {
					@f_meta3
				}
    ...
    function inner($posts, $td_column_number = '') {
        ...
        if (!empty($posts)) {
            ...
            foreach ( $posts as $post ) {
                ...
                $td_module_flex_2 = new td_module_flex_8($post, $this->get_all_atts());
            ...
            if ($post_count < self::POST_LIMIT) {
                for ($i = $post_count; $i < self::POST_LIMIT; $i++) {
                    ...
                    $buffy .= $td_module_flex_2->render($i, 'td_module_flex_8');
