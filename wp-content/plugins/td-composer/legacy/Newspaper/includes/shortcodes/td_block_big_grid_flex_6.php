        ...
        $raw_css =
            "<style>
				...
				@media (min-width: 767px) {
                    ...
                    div.$unique_block_class .td-big-grid-flex-post-3 {
				...
				/* @image_height3 */
                @media (max-width: 767px) {
                    div.$unique_block_class .td-big-grid-flex-post-3 .td-image-wrap,
                    div.$unique_block_class .td-big-grid-flex-post-4 .td-image-wrap {
				...
				/* @video_icon3 */
                @media (max-width: 767px) {
                    div.$unique_block_class .td-big-grid-flex-post-3 .td-video-play-ico,
                    div.$unique_block_class .td-big-grid-flex-post-4 .td-video-play-ico {
                        width: @video_icon3;
                        height: @video_icon3;
				...
				/* @image_width1 */
				div.$unique_block_class .td-big-grid-flex-column,
                ...
                @media (max-width: 767px) {
                    div.$unique_block_class .td-big-grid-flex-post-3,
                    div.$unique_block_class .td-big-grid-flex-post-4 {
					    width: @image_width3;
                    }
				}
				...
				/* @meta_width3 */
                @media (max-width: 767px) {
                    div.$unique_block_class .td-big-grid-flex-post-3 .td-module-meta-info,
                    div.$unique_block_class .td-big-grid-flex-post-4 .td-module-meta-info {
					    width: @meta_width3;
                    }
				}
				...
				/* @art_title3 */
                @media (max-width: 767px) {
                    div.$unique_block_class .td-big-grid-flex-post-3 .tdb-module-title-wrap,
                    div.$unique_block_class .td-big-grid-flex-post-4 .tdb-module-title-wrap {
					    margin: @art_title3;
                    }
				}
				...
				/* @art_title_padd3 */
                @media (max-width: 767px) {
                    div.$unique_block_class .td-big-grid-flex-post-3 .entry-title,
                    div.$unique_block_class .td-big-grid-flex-post-4 .entry-title {
				...
				/* @auth_date_padding3 */
                @media (max-width: 767px) {
                    div.$unique_block_class .td-big-grid-flex-post-3 .td-editor-date,
                    div.$unique_block_class .td-big-grid-flex-post-4 .td-editor-date {
                ...
                @media (max-width: 767px) {
                    div.$unique_block_class .td-big-grid-flex-post-3 .td-post-category,
                    div.$unique_block_class .td-big-grid-flex-post-4 .td-post-category {
				...
				/* @show_author3 */
                @media (max-width: 767px) {
                    div.$unique_block_class .td-big-grid-flex-post-3 .td-post-author-name,
                    div.$unique_block_class .td-big-grid-flex-post-4 .td-post-author-name {
				...
				/* @show_date3 */
                @media (max-width: 767px) {
                    div.$unique_block_class .td-big-grid-flex-post-3 .td-post-date,
                    div.$unique_block_class .td-big-grid-flex-post-3 .td-post-author-name span,
                    div.$unique_block_class .td-big-grid-flex-post-4 .td-post-date,
                    div.$unique_block_class .td-big-grid-flex-post-4 .td-post-author-name span {
					    display: @show_date3;
                    }
				}
				...
				/* @show_review3 */
                @media (max-width: 767px) {
                    div.$unique_block_class .td-big-grid-flex-post-3 .entry-review-stars,
                    div.$unique_block_class .td-big-grid-flex-post-4 .entry-review-stars {
                        display: @show_review3;
                    }
                }
				/* @review_size3 */
                @media (max-width: 767px) {
                    div.$unique_block_class .td-big-grid-flex-post-3 .td-icon-star,
                    div.$unique_block_class .td-big-grid-flex-post-3 .td-icon-star-empty,
                    div.$unique_block_class .td-big-grid-flex-post-3 .td-icon-star-half,
                    div.$unique_block_class .td-big-grid-flex-post-4 .td-icon-star,
                    div.$unique_block_class .td-big-grid-flex-post-4 .td-icon-star-empty,
                    div.$unique_block_class .td-big-grid-flex-post-4 .td-icon-star-half  {
                ...
                @media (max-width: 767px) {
                    div.$unique_block_class .td-big-grid-flex-post-3 .td-editor-date,
                    div.$unique_block_class .td-big-grid-flex-post-3 .td-module-comments a,
                    div.$unique_block_class .td-big-grid-flex-post-4 .td-editor-date,
                    div.$unique_block_class .td-big-grid-flex-post-4 .td-module-comments a {
					    @f_meta3
                    }
				}
