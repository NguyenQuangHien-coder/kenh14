...
{label:__("Left"),value:"left"},{label:__("Center"),value:"center"},{label:__("Right"),value:"right"}],t=b.attributes.dropCapStyle,u=[{label:__("Box"),value:"dropcapp"},{label:__("Circle"),value:"dropcapp1"},{label:__("Regular"),value:"dropcapp2"},{label:__("Bold"),value:"dropcapp3"},{label:__("Small Circle"),value:"dropcapp4"}],v=d||e||f;return el(Fragment,null,el(c,b),h&&el(BlockControls,null,el(withState({activeControl:b.attributes.tdButtonSize?b.attributes.tdButtonSize:"normal"})(function(a){var c=
a.activeControl,d=a.setState;return el(Toolbar,{className:"td-button-size-toolbar",controls:[{icon:btnSizeSmall,title:__("Small Button"),isActive:"small"===c,onClick:function(){return d(function(){b.setAttributes({tdButtonSize:"small"})})}},{icon:btnSizeMedium,title:__("Normal Button"),isActive:"normal"===c,onClick:function(){return d(function(){b.setAttributes({tdButtonSize:"normal"})})}},{icon:btnSizeLarge,title:__("Large Button"),isActive:"large"===c,onClick:function(){return d(function(){b.setAttributes({tdButtonSize:"large"})})}}]})}),
null)),el(InspectorControls,null,a&&el(PanelBody,{title:"Theme Settings",className:"components-panel__body td-components-panel__body",initialOpen:v,icon:tagDivIcon},d&&k&&el(withState({checked:b.attributes.tdShowModal})(function(a){var c=a.setState;return el(ToggleControl,{label:"LightBox",help:"Enable/Disable the Image LightBox",checked:b.attributes.tdShowModal,className:"none"!==b.attributes.linkDestination?"td-disabled-control":"",onChange:function(){return c(function(a){b.setAttributes({tdShowModal:!a.checked});
