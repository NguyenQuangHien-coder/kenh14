...
(a.itemImgRetinaSrc=jQuery(b).data("img-retina-url"));tdAnimationStack._initialize_item(a);f.push(a)});!0===d?(tdAnimationStack.log("%c live load items ","background: brown; color: white;"),tdAnimationStack._precompute_items(f,b,c),tdAnimationStack.compute_items(d)):(tdAnimationStack.log("%c preload items ","background: brown; color: white;"),function(){for(var a=!0,d=0;d<f.length;d++)if(!1===e[d].complete){a=!1;break}if(!1===a){var p=(new Date).getTime();tdAnimationStack.log("TIMER - started");var u=
setInterval(function(){var d;if((new Date).getTime()-p>tdAnimationStack.max_waiting_for_init)for(clearInterval(u),d=0;d<f.length;d++)f[d].jqueryObj.removeClass(tdAnimationStack._animation_css_class1),f[d].jqueryObj.addClass(tdAnimationStack._animation_css_class2);else{a=!0;for(d=0;d<f.length;d++)if(!1===e[d].complete){a=!1;break}!0===a&&(clearInterval(u),tdAnimationStack.log("TIMER - stopped"),tdAnimationStack._precompute_items(f,b,c),tdAnimationStack.compute_items(!1))}},100)}else tdAnimationStack._precompute_items(f,
...
"background: #fc6600; color: #fff;"),a.jqueryObj.removeClass(tdAnimationStack._animation_css_class1),a.jqueryObj.addClass(tdAnimationStack._animation_css_class2);else if(b=a.itemType,void 0!==b)switch(b){case "image_tag":tdAnimationStack.log("%c image tag ","background: #3ded97; color: #fff;");a.jqueryObj.data("complete",!1);if(void 0!==a.itemImgRetinaSrc&&!0===tdAnimationStack._isHighDensity())a.jqueryObj.attr("src",a.itemImgRetinaSrc).on("load",function(){a.jqueryObj.data("complete",!0)});else a.jqueryObj.attr("src",
a.itemSrc).on("load",function(){a.jqueryObj.data("complete",!0)});var c=(new Date).getTime(),d=setInterval(function(){var b=new Date;!0===a.jqueryObj.data("complete")?(clearInterval(d),a.jqueryObj.removeClass(tdAnimationStack._animation_css_class1),a.jqueryObj.addClass(tdAnimationStack._animation_css_class2)):b.getTime()-c>tdAnimationStack.max_waiting_for_init&&(clearInterval(d),a.jqueryObj.removeClass(tdAnimationStack._animation_css_class1),a.jqueryObj.addClass(tdAnimationStack._animation_css_class2))},
100);break;case "css_image":a.jqueryObj.data("complete",!1);tdAnimationStack.log("%c image tag ","background: #3ded97; color: #fff;");if(void 0!==a.itemImgRetinaSrc&&!0===tdAnimationStack._isHighDensity())jQuery("<img/>").attr("src",a.itemImgRetinaSrc).on("load",function(){jQuery(this).remove();a.jqueryObj.data("complete",!0)});else jQuery("<img/>").attr("src",a.itemSrc).on("load",function(){jQuery(this).remove();a.jqueryObj.data("complete",!0)});var f=(new Date).getTime(),e=setInterval(function(){var b=
new Date;!0===a.jqueryObj.data("complete")?(void 0!==a.itemImgRetinaSrc&&!0===tdAnimationStack._isHighDensity()?a.jqueryObj.attr("style",'background-image: url("'+a.itemImgRetinaSrc+'")'):a.jqueryObj.attr("style",'background-image: url("'+a.itemSrc+'")'),clearInterval(e),a.jqueryObj.removeClass(tdAnimationStack._animation_css_class1),a.jqueryObj.addClass(tdAnimationStack._animation_css_class2)):b.getTime()-f>tdAnimationStack.max_waiting_for_init&&(clearInterval(e),void 0!==a.itemImgRetinaSrc&&!0===
tdAnimationStack._isHighDensity()?a.jqueryObj.attr("style",'background-image: url("'+a.itemImgRetinaSrc+'")'):a.jqueryObj.attr("style",'background-image: url("'+a.itemSrc+'")'),a.jqueryObj.removeClass(tdAnimationStack._animation_css_class1),a.jqueryObj.addClass(tdAnimationStack._animation_css_class2))},100)}},td_events_scroll:function(){tdAnimationStack.compute_items(!0)},td_events_resize:function(){clearInterval(tdAnimationStack._current_interval);tdAnimationStack.reinit()},log:function(a,b){},_isHighDensity:function(){return window.matchMedia&&
