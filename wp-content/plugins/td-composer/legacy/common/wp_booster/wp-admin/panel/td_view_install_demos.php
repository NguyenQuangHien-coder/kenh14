        ...
        <?php } else if ( TD_THEME_NAME == 'Newspaper' ) { ?>
            ...
            <div id="demos" class="td-demos">
                <div class="td-demo-filter td-sd-demos">
                    <ul>
                        <li class="td-pro-list-item"><a href="#" target="_blank" class="td-demo-filter-active" data-type="pro">PRO</a>
                            ...
                            <div class="td-demo-product-inner">
                                ...
                                <div class="td-demo-image <?php echo $badge_class ?>">
                                    <a class="td-demo-image-inner" target="_blank" href="<?php echo td_global::$demo_list[$demo_id]['demo_url'] ?>">
                                        <img data-scr="https://demo.tagdiv.com/select_demo/images/newspaper/demos/<?php echo $demo_id ?>.jpg" src="https://demo.tagdiv.com/select_demo/images/newspaper/demos/<?php echo $demo_id ?>.jpg" alt="" class="td-demo-img">
