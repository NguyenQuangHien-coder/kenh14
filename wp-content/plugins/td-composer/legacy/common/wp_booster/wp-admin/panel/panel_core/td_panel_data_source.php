...
//            case 'td_fonts_mob':
//                $fonts_user_inserted = td_options::get_array('td_fonts_mob');
//                if(!empty($fonts_user_inserted[$read_array['item_id']][$read_array['option_id']])) {
//                    return $fonts_user_inserted[$read_array['item_id']][$read_array['option_id']];
//                }
//                break;
...
//                case 'td_fonts_mob':
//                    self::update_td_fonts($post_value, 'td_fonts_mob');
//                    break;
...
//	                }
     ...
     */
    private static function update_td_fonts($user_custom_fonts_array, $db_option_name = 'td_fonts' ) {
        //get defaults array
        $default_array = $_POST['td_default'];
        ...
        foreach ($user_custom_fonts_array as $font_place => $font_options) {
            ...
            foreach ($font_options as $font_option_id => $font_option_value) {
                ...
                if(!empty($default_array[$db_option_name][$font_place]['color'])) {
                    $td_fonts_save[$font_place]['color'] = $default_array[$db_option_name][$font_place]['color'];
                }
            }
        ...
        $font_sections_from_db = td_options::get_array($db_option_name);//get the fonts from db
	    ...
	    td_options::update_array($db_option_name, $td_fonts_save);
