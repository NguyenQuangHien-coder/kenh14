...
class td_smart_list_mob_2 extends td_smart_list {
    ...
    protected function render_before_list_wrap() {
        ...
        $buffy .= '<div class="tdm_smart_list_2' . $td_class_nr_of_columns . '">';
    ...
    protected function render_list_item($item_array, $current_item_id, $current_item_number, $total_items_number) {
        ...
        $first_img_alt = $first_img_all_info['alt'];
        ...
        if(td_global::$cur_single_template_sidebar_pos == 'no_sidebar') {
            ...
            $first_img_info = wp_get_attachment_image_src($item_array['first_img_id'], 'td_741x486');
        }
