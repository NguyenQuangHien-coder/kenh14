...
jQuery( document ).ready(function($) {
	...
	$('.google-fonts-list').on('change', function() {
		...
		var indexes = $.map(bodyfontcontrol.pepefontslist, function(obj, index) {
		...
		$.each(bodyfontcontrol.pepefontslist[index].variants, function(val, text) {
		...
		$(this).parent().parent().find('.google-fonts-category').val(bodyfontcontrol.pepefontslist[index].category);
 ...
 */
( function( $, api ) {
	api.sectionConstructor['pepe-lite-upsell'] = api.Section.extend( {
